...
class BookDashboard extends Controller
{
    ...
    public function create()
    {
        ...
        return view('dashboard.books.create', compact(['categories', 'user', 'authors']));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::all();
        $authors = Author::all();
        return view('dashboard.books.edit', compact(['book', 'categories', 'user', 'authors']));
    }
    ...
    public function update(Request $request, $id)
    {
        $validated = $request->validate([
            'title'            => 'required|string|max:255',
            'slug'             => 'required|string|unique:books,slug,' . $id,
            'author_id'        => 'required|exists:authors,id',
            'translator'       => 'nullable|string|max:255',
            'publisher'        => 'nullable|string|max:255',
            'publish_date'     => 'nullable|string|max:255',
