...
<div class="bg-white shadow p-6 rounded-lg">
    <h1 class="text-xl font-bold mb-4">Tạo sách mới</h1>
    ...
    <form action="{{ route('dashboard.books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            ...
            <input type="number" name="total_copies" value="{{ old('total_copies') }}"
                class="w-full border rounded px-3 py-2 focus:ring focus:ring-blue-200">
        </div>
        ...
        <div>
            ...
            <input type="number" name="available_copies" value="{{ old('available_copies') }}"
                class="w-full border rounded px-3 py-2 focus:ring focus:ring-blue-200">
        </div>
