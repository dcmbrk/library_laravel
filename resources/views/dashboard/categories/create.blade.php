...
<div class="max-w-lg mx-auto bg-white shadow-md rounded-lg p-6">
    ...
    <form action="{{ route('categories.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            <label for="name" class="block text-md font-medium text-gray-700">Tên danh mục</label>
            <input type="text" name="name" id="name" value="{{ old('name') }}"
                class="outline-none p-2 border mt-2 block w-full rounded-md border-gray-300 shadow-sm  focus:border-gray-500">
        </div>
