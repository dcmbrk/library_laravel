<header>
    <div
        class="h-8 bg-gradient-to-r from-black/95 via-black/90 to-black/85 underline font-bold text-white flex items-center justify-center">
        The smallest sussy open
        library in human history.</div>
